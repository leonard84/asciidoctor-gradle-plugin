...
The plugin adds a new task named `asciidoctor`. This task exposes 9 properties as part of its configuration
...
baseDir:: the base directory containing the document and resources. Such as `docinfo.html` Default: `${project.projectDir}` 
